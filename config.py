...
class Config(object):
    ...
    DB_URL  = os.environ.get("DB_URL","mongodp")
    PORT = os.environ.get("PORT", "8080")
 
    # other configs
    BOT_UPTIME  = time.time()
    START_PIC   = os.environ.get("START_PIC", "https://graph.org/file/29a3acbbab9de5f45a5fe.jpg")
    ADMIN       = [int(admin) if id_pattern.search(admin) else admin for admin in os.environ.get('ADMIN', '8480922250').split()]
    FORCE_SUB_CHANNELS = os.environ.get('FORCE_SUB_CHANNELS', 'Akd_Animess').split(',')
    LOG_CHANNEL = int(os.environ.get("LOG_CHANNEL", "-1003964975750"))
    DUMP_CHANNEL = int(os.environ.get("DUMP_CHANNEL", "-1003945443318"))
